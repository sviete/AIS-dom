...
import pl.sviete.dom.views.animators.BarParamsAnimator;
import pl.sviete.dom.views.animators.IdleAnimator;
import pl.sviete.dom.views.animators.RmsAnimator;
import pl.sviete.dom.views.animators.RotatingAnimator;
import pl.sviete.dom.views.animators.TransformAnimator;
...
public class RecognitionProgressView extends View implements RecognitionListener {
    ...
    private final List<pl.sviete.dom.views.RecognitionBar> recognitionBars = new ArrayList<>();
    private Paint paint;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < recognitionBars.size(); i++) {
            pl.sviete.dom.views.RecognitionBar bar = recognitionBars.get(i);
            if (barColors != null) {
    ...
    private void initBars() {
        ...
        for (int i = 0; i < BARS_COUNT; i++) {
            ...
            pl.sviete.dom.views.RecognitionBar bar = new pl.sviete.dom.views.RecognitionBar(x, getMeasuredHeight() / 2, 2 * radius, heights.get(i), radius);
    ...
    private void resetBars() {
        for (pl.sviete.dom.views.RecognitionBar bar : recognitionBars) {
